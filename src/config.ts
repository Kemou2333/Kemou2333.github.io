...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		hue: 305, // Default blue-purple hue, from 0 to 360
		fixed: false, // Hide the theme color picker for visitors
	},
	banner: {
		enable: true,
		src: "/assets/images/kemou-hero.webp", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
